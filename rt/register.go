...
func register(groupRouter *gin.RouterGroup, route *Route) {
	isGRoup := checkRoute(*route)
	if isGRoup {
...
func registerGroup(groupRouter *gin.RouterGroup, route *Route) {
...
func registerRouter(groupRouter *gin.RouterGroup, route *Route) {
...
func handleBindAll(route *Route) gin.HandlerFunc {
...
func handleTX(route *Route) gin.HandlerFunc {
...
func handleTYPE(route *Route) gin.HandlerFunc {
	return func(c *gin.Context) {
